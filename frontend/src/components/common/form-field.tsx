...
// Form field building blocks shared by every form in the app (the ticket
// dialog, the Lookups dialogs): label + required mark + control + one message
// line that is either the error or the hint, wired up for screen readers.
